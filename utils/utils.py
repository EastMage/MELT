...
def parse_args():
    ...
    parser.add_argument("--train_pkl", type=str, default="./dataset/processed_data/mortality_mimic3_dataset_train.pkl",
                        help="A path to dataset folder")
    parser.add_argument("--val_pkl", type=str, default="./dataset/processed_data/mortality_mimic3_dataset_val.pkl",
                        help="A path to dataset folder")
    parser.add_argument("--test_pkl", type=str, default="./dataset/processed_data/mortality_mimic3_dataset_test.pkl",
                        help="A path to dataset folder")
    parser.add_argument("--output_path", type=str, default="./weights/lab", help="Where to store the final model.")
    parser.add_argument("--seed", type=int, default=42, help="A seed for reproducible training.")
    parser.add_argument("--use_pretrained_emb", type=bool, default=True, help="A seed for reproducible training.")

    parser.add_argument("--hidden_dim", type=int, default=512, help="The dimension of medications.")
    parser.add_argument("--text_embed_size", type=int, default=768, help="The dimension of medications.")
    parser.add_argument("--drop_ratio", type=float, default=0.2 , help="The dimension of medications.")
    ...
    # parser.add_argument("--dim_triage", type=int, default=5, help="The dimension of triage variables.")
    # parser.add_argument("--dim_labtest", type=int, default=59, help="The dimension of labtest.")
    # parser.add_argument("--dim_medications", type=int, default=474, help="The dimension of medications.")
    # parser.add_argument("--dim_diagnoses", type=int, default=15795, help="The dimension of diagnoses.")
    # parser.add_argument("--dim_notes", type=int, default=768, help="The dimension of medical notes.")

    parser.add_argument("--dim_triage", type=int, default=5, help="The dimension of triage variables.")
    parser.add_argument("--dim_labtest", type=int, default=59, help="The dimension of labtest.")
    parser.add_argument("--dim_medications", type=int, default=406, help="The dimension of medications.")
    parser.add_argument("--dim_diagnoses", type=int, default=5741, help="The dimension of diagnoses.")
    parser.add_argument("--dim_notes", type=int, default=768, help="The dimension of medical notes.")
    ...
    parser.add_argument("--txt_learning_rate", type=float, default=1e-5, help="Initial learning rate to use.")
    ...
    parser.add_argument("--alpha", type=float, default=0.01, help="Weight decay to use.")

    parser.add_argument("--ib_beta", type=float, default=0.1, help="Information bottleneck regularization strength.")
    parser.add_argument("--sparse_lambda", type=float, default=0.05, help="Sparse gating regularization strength.")
    parser.add_argument("--pred_alpha", type=float, default=1.0, help="Prediction loss weight.")
    ...
    parser.add_argument('--num_of_notes', help='Number of notes to include for a patient input 0 for all the notes', type=int, default=1)
    parser.add_argument('--num_of_labtests', help='Number of labtest to include for a patient input 0 for all the notes', type=int, default=24)
